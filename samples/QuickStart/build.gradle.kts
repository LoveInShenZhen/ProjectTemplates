...
tasks.register<Delete>("rmLocalSzJarsCache") {
    ...
    this.delete(path)
    println("remove Local Maven Cache For Sz jars: $path")
    ...
    println("remove Local Gradle Cache For Sz jars: $gradleCachePath")
}
