...
dependencies {
    ...
    implementation("com.github.kklongming:sz-scaffold:3.0.0-dev")
    implementation("com.github.kklongming:sz-api-doc:3.0.0-dev")
    implementation("com.github.kklongming:sz-plan-task:3.0.0-dev")
